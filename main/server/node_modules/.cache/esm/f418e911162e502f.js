let comparePassword,hashPassword,jwt,User,Job;_162‍.x([["signUp",()=>signUp],["signIn",()=>signIn],["totalJobs",()=>totalJobs]]);_162‍.w("../helpers/encryptPass",[["comparePassword",["comparePassword"],function(v){comparePassword=v}],["hashPassword",["hashPassword"],function(v){hashPassword=v}]]);_162‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_162‍.w("../Models/Auth",[["default",["User"],function(v){User=v}]]);_162‍.w("../Models/Job",[["default",["Job"],function(v){Job=v}]]);
