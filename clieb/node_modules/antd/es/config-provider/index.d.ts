...
import type { ConfigConsumerProps, CSPConfig, DirectionType, Theme, ThemeConfig } from 'antd/es/config-provider/context';
import { ConfigConsumer, ConfigContext, defaultIconPrefixCls } from 'antd/es/config-provider/context';
