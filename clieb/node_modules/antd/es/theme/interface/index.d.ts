...
export type { PresetColorType, ColorPalettes } from 'antd/es/theme/interface/presetColors';
export type { SeedToken } from 'antd/es/theme/interface/seeds';
export type { MapToken, ColorMapToken, ColorNeutralMapToken, CommonMapToken, HeightMapToken, SizeMapToken, FontSizeMapToken, StyleMapToken, } from 'antd/es/theme/interface/maps';
