...
import type { KeyWiseTransferItem } from 'antd/es/transfer';
import type { ElementOf } from 'antd/es/_util/type';
import type { RenderedItem, TransferListProps } from 'antd/es/transfer/list';
